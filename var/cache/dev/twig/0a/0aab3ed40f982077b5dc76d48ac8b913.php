...
/* post/new.html.twig */
class __TwigTemplate_91680705e362ece5961516be358827be extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {{form_widget(form)}}
        <button class=\"btn btn-success mt-5\">Add</button>
    {{ form_end(form)}}
{%endblock%}", "post/new.html.twig", "/Users/magalseck/Downloads/PWL3/templates/post/new.html.twig");
    }
}
