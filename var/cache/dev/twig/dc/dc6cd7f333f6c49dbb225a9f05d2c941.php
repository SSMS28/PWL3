...
class __TwigTemplate_3acbb7042409d24b10b061e139632ee7 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["post"]) {
            ...
            echo "</p>
                <img src=\"https://picsum.photos/300/200?grayscale\" alt=\"\" class=\"mt-3 mb-3\"><br>
                <a href=\"";
            // line 59
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post_show", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 59)]), "html", null, true);
            echo "\">Read more</a>
                </div>
                <hr>     
            </article>
    ...
    <div class=\"navigation\">
        ";
        // line 67
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["posts"]) || array_key_exists("posts", $context) ? $context["posts"] : (function () { throw new RuntimeError('Variable "posts" does not exist.', 67, $this->source); })()));
        echo "
    </div>
";
    ...
    {
        return array (  182 => 67,  178 => 65,  166 => 59,  161 => 57,  154 => 53,  150 => 52,  146 => 51,  141 => 49,  137 => 47,  133 => 46,  126 => 41,  120 => 36,  116 => 33,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "categories/terrain.html.twig", "/Users/magalseck/downloads/PWL3/templates/categories/terrain.html.twig");
    }
}
